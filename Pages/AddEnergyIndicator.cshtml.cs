...
namespace t4_pr1_LlucVelazquez.Pages
{
    public class AddEnergyIndicatorModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            var energyIndicator = new List<EnergyIndicator>
            {
                new EnergyIndicator { Data = NewEnergyIndicator.Data, PBEE_Hidroelectr = 0, PBEE_Carbo = 0, PBEE_GasNat = 0, PBEE_Fuel_Oil = 0, PBEE_CiclComb = 0, PBEE_Nuclear = 0, 
